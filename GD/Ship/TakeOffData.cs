...
namespace IngameScript
{
    class TakeOffData
    {
        public TakeOffStatus CurrentState = TakeOffStatus.Idle;
        ...
        public void Initialize(Vector3D origin, Vector3D destination, string commad)
        {
            ...
            Command = commad;
            HasTarget = true;
            CurrentState = TakeOffStatus.Separating;
        }
        public void Clear()
        {
            ...
            Command = null;
            HasTarget = false;
            CurrentState = TakeOffStatus.Idle;
        }
        ...
        public void LoadFromStorage(string storageLine)
        {
            ...
            CurrentState = (TakeOffStatus)Utils.ReadInt(parts, "CurrentState");
